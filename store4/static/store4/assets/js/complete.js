...
.then((data) => {
  ...
  // ------- UI helpers -------
  function setPaymentDetails(paymentSession) {
    ...
    document.querySelector("#intent-id").textContent = paymentSession.id;
    document.querySelector("#intent-status").textContent = paymentSession.status;
    document.querySelector("#view-details").href = `https://dashboard.stripe.com/payments/${paymentSession.id}`;
  }
  ...
  async function checkStatus() {
    ...
    setPaymentDetails(paymentSession);
  }
});
